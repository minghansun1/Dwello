...
# We generated this using the already existing database.
...
class County(models.Model):
    county = models.CharField(primary_key=True, max_length=255)  # The composite primary key (county, state_id, family_member_count) found, that is not supported. The first column is selected.
    state = models.ForeignKey('State', models.DO_NOTHING)
    ...
    housing_cost = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
    food_cost = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
    healthcare_cost = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
    childcare_cost = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
    taxes = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
    total_cost = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
    median_family_income = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)
...
class IndustryCityData(models.Model):
    ...
    jobs_1000 = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    a_mean = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    a_pct10 = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    a_pct25 = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    a_median = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    a_pct75 = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    a_pct90 = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    h_mean = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    h_pct10 = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    h_pct25 = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    h_median = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    h_pct75 = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    h_pct90 = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
...
class UserLikesNeighborhood(models.Model):
    user_id = models.IntegerField(primary_key=True)  # The composite primary key (user_id, neighborhood_id) found, that is not supported. The first column is selected.
    neighborhood_id = models.IntegerField()

    class Meta:
        managed = False
        db_table = 'user_likes_neighborhood'
        unique_together = (('user_id', 'neighborhood_id'),)


class UserLikesState(models.Model):
    user = models.OneToOneField('UserTable', models.DO_NOTHING, primary_key=True)  # The composite primary key (user_id, state_id) found, that is not supported. The first column is selected.
    state = models.ForeignKey(State, models.DO_NOTHING)
...
class UserLikesZipcode(models.Model):
    user_id = models.IntegerField(primary_key=True)  # The composite primary key (user_id, zip_code) found, that is not supported. The first column is selected.
    zip_code = models.CharField(max_length=10)

    class Meta:
        managed = False
        db_table = 'user_likes_zipcode'
        unique_together = (('user_id', 'zip_code'),)
...
class ZipCode(models.Model):
    ...
    median_income = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
