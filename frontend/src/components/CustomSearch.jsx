        ...
        <div className="flex justify-center mt-8">
            ...
            onClick={() => {
                ...
                const searchParams = {
                    ...
                    preferred_lat: parseInt(latitude) || 0,
                    preferred_lng: parseInt(longitude) || 0,
            ...
            api.post("/api/neighborhoods/preference-ranking/", {
                data: searchParams
            })
                .then((response) => {
